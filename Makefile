...
FLAGS = -pedantic -Wall -mtune=arm7tdmi -mcpu=arm7tdmi -ffreestanding -O3 -ffast-math -mlong-calls -faggressive-loop-optimizations -Wno-unused
...
lcg.o: lcg.cpp lcg.h
loader.o: loader.cpp
main.o: main.cpp slider.h arm7type.hpp Graphic.hpp Keypad.hpp Number.hpp \
 Draw.hpp Square.hpp
minstd.o: minstd.cpp minstd.h lcg.h
slider.o: slider.cpp slider.h minstd.h lcg.h
